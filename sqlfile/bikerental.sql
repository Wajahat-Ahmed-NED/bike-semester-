...
Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the -> website (the "Service") operated by  ("us", "we", or "our").
...
(3, 'About Us ', 'aboutus', '<span style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; text-align: justify;">WE ARE THE BSS MANAGER. The only 100% dedicated bike SS booking website. The first BSS Manager (BSSM) shop was our own bike shop. Ever Since it has been our aim to make bike SS easier for everyone, everywhere.We focus on making bike SSs easier for you.Your SS business has a unique set of challenges. We are the only dedicated bike SS site and will be able to offer you a solution to match your needs.Get in touch with us today! We provide affordable bike rates, we hae lost of Satiisfied customers feedback, you can have a look at our home page too!! </span>'),
...
(2, 'demo@gmail.com', '\nI think this is the one and only top bike SS site in the world. 5-Stars from me - Full satisfaction, no complain at all', '2017-06-18 07:46:05', 1);
